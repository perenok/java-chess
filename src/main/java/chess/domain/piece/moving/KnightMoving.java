...
public class KnightMoving implements PieceMoving {
    ...
    public KnightMoving(KnightDirections knightDirections, Position currentPosition) {
        this.pieceDirections = knightDirections;
